...
SKILL = {
	...
	{"skill_display_persist_time",{{1,300},{9,300}}},
	},

	SKILL_LEVEL_COST_ATTRIB	  =	--技能等级相关消耗属性
	{
	{"cost_mana_point",{{1,5},{9,9}}}
	},
	...
	damage_factor_z={{1,1},{9,5}},
	damage_factor_b={{1,1},{9,1}},
	damage_factor_m={{1,15},{9,15}},
	},
	{magic="state_be_attacked_2_magic",
	damage_factor_z={{1,6553652},{9,6553652}},
	},
