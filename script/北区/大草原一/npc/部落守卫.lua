...
if ( UWorld1401 == 80  )  then
				Talk(2,"say1401_12","Lµm g× cã tªn ng­êi H¸n nµo? Phİa tr­íc lµ <color=yellow>Bé L¹c V­¬ng Kú<color> nh­ng ng­¬i kh«ng dÔ dµng vµo ®­îc ®ã ®©u!","Ta ®­îc mét ng­êi ñy th¸c ®Õn ®©y t×m ng­êi th©n vµ b¹n bÌ cña hä.")
...
elseif ( UWorld1401  >= 100 ) then
				...
				Talk(1,"","Phİa tr­íc lµ <color=yellow>Bé L¹c V­¬ng Kú<color>! Ng­êi H¸n kh«ng thÓ vµo ®ã ®­îc!")
end
end;
...
function  grease1401_12()
	Say("B¹n quyÕt ®Şnh dïng 50 l­îng hèi lé thñ vÖ bé l¹c?",2,"§­îc/grease1401_12yes","Ta suy nghÜ l¹i!/grease1401_12no")
end;
...
function  grease1401_12yes()
			if ( GetCash() >= 500000  )  then
				    Talk(2,"","VÊt v¶ cho c¸c huynh ®Ö qu¸, chót tiÒn trµ n­íc xin nhËn cho!","Ng­êi H¸n c¸c ng­¬i xem ra còng cã t×nh cã nghÜa! Sao ta nì tõ chèi ®­îc, ng­¬i mau ®Õn <color=yellow>Bé L¹c V­¬ng Kú<color> hái th¨m tin tøc cña hä.")
						Pay(500000)
				    SetTask(1401,100)
    				--AddNote("¿ÉÒÔÈ¥ÍõÆì²¿Âä´òÌıÏôÑàÑàÓëº«µÂÈÃµÄÏÂÂäÁË¡£")
    				TaskTip("§Õn Bé L¹c V­¬ng Kú hái th¨m tin tøc cña Tiªu YÕn YÕn vµ Hµn §øc Nh­îng.")
...
function  yes1401_12()
    ...
    SetTask(1401,85)
		...
		TaskTip("Quay l¹i hái Nhiªu L©n t×m c¸ch v­ît ¶i.")
