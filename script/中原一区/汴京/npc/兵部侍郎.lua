		...
		Talk(1,"say1401_5","§¹i Tèng ®¹i lo¹n, Quèc gia h­ng vong, thÊt phu h÷u tr¸ch. TiÓu nh©n còng xin ®Õn b¸o danh ®Çu qu©n giÕt giÆc!")
			...
			elseif ( UWorld1401  == 35 and GetItemCount(2,1,19) >= 1 ) then
						    ...
						    if  DelItem(2,1,19,1) == 1 then
										 ...
										 --Earn(150000);
										 --AddNote("È¥Ìì²¨Ñî¸®µÄÙÜÀÏÌ«¾ı´¦ÒªÇóÉÏÑãÃÅ¹ØÇ°Ïß")
					...
					elseif ( UWorld1401  == 35 and GetItemCount(2,1,19) < 1 ) then
						Talk(1,"","§Ó kh¶o nghiÖm n¨ng lùc cña ng­¬i, h·y ®Õn ch©n nói <color=red>ThiÕu L©m tù<color> ®¸nh <color=red>Hæ d÷<color> lÊy vÒ <color=red>1 c¸i ®u«i hæ<color>!")
					elseif ( UWorld1401  == 40 ) then
						Talk(1,"","Cã viÖc g× h·y ®Õn <color=red>Thiªn Ba D­¬ng Phñ<color> gÆp <color=red>Xa Th¸i Qu©n<color> mµ hái! Hái ta còng v« İch!")
							else
...
function  say1401_5()
		Say("H¨ng h¸i ®Çu qu©n, ta rÊt hoan nghªnh nh­ng ng­¬i cÇn mang ®Õn <color=red>1 c¸i ®u«i hæ<color> ®Ó chøng tá thùc lùc cña ng­¬i!",2,"Cã thÓ/yes1401_5","Kh«ng thÓ/no1401_5")
end;

function  yes1401_5()
		Talk(2,"","X¸ g× 1 c¸i ®u«i hæ! Ta ®i ngay ®©y!","§Ó kh¶o nghiÖm n¨ng lùc cña ng­¬i, h·y ®Õn ch©n nói <color=red>ThiÕu L©m tù<color> ®¸nh <color=red>Hæ d÷<color> lÊy vÒ <color=red>1 c¸i ®u«i hæ<color>!")
		SetTask(1401,35)
		--AddNote("È¥ÊÕ¼¯1¸ù»¢Î²£¬²ÅÄÜ²Î¾ü¡£")
		Msg2Player("§i thu thËp 1 c¸i ®u«i hæ míi cã thÓ ®Çu qu©n!")
end;
