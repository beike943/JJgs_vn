...
function main()
	...
	if( UWorld1401 == 25 and UWorld1411 == 0  )  then
		Talk(2,"","Bé ®Çu ®¹i nh©n! T¹i h¹ nghe nãi cã mét ®¸m ng­êi mÆc quan phôc trµ trén vµo thiªn lao gi¶i cøu tï nh©n!","Cã chuyÖn vËy sao? Ph¶n råi! §a t¹ ®· b¸o tin! §©y chót t¹ lÔ xin h·y nhËn lÊy!")
   		SetTask(1411,5)
    		Earn(1500)
    		GivePlayerExp(SkeyTianmenzhen,"xunwen")
    		ModifyReputation(5,0)
    		--AddNote("ÍµÍµ°Ñ½ÙÓüµÄÊÂÇé¸æËßÁË¹Ù¸®¡£")
    		TaskTip("Bİ mËt b¸o quan phñ chuyÖn c­íp ngôc!")
    		return
	end
	...
	--¼ì²éÊ±¼äÊÇ·ñÎªÖÜÒ»ÖÁÖÜËÄ20µãÖÁ24·Ö
	if CheckTime() == 1 then
...
--	if nTotal_DoNum < 100 then 
		...
		Say(strButouTitle.."Theo tin th¸m b¸o, s¸t thñ <color=yellow>"..nKillerName.."<color> gÇn ®©y hay xuÊt hiÖn t¹i <color=yellow>"..nMapName.."("..nMx..","..nMy..")<color>. H·y ®i diÖt trõ h¾n trõ hËu häa!",0);--£¨ÕâÊÇ±¾´Î¸Ã²¶Í··¢²¼µÄµÄµÚ<color=yellow>"..nTotal_DoNum.."<color>´ÎÈÎÎñ£¬Ã¿´Î·¢²¼ÈÎÎñÉÏÏŞÎª<color=yellow>100<color>´Î¡££©",0);
