...
-- ½éÉÜÏà¹ØÐÅÏ¢
function Info()
	Say(strTitle.."<color=yellow>H¸i thuèc<color> lµ mét trong <color=yellow>6<color> kü n¨ng thu thËp. Häc ®­îc kü n¨ng nµy míi t×m ®­îc nguyªn liÖu <color=yellow>chÕ thuèc<color>. Ng­¬i cã thÓ ®Õn <color=yellow>tiÖm t¹p hãa<color> mua c«ng cô h¸i thuèc <color=yellow>s¬ cÊp<color> sau ®ã ra ngoµi h¸i thuèc. NÕu muèn ®Õn U Cèc nªn ghÐ <color=yellow>Ngù c¸c<color> mua <color=yellow>ThÇn N«ng §¬n<color> mang theo.", 0);
end;
