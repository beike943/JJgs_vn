...
UWorld1401 = GetTask(1401)
	...
	elseif ( UWorld1401  == 20 and GetItemCount(2,1,34) >= 5 )then
				if  DelItem(2,1,34,5) == 1 then
						    ...
						    --AddNote("µÃÖª¡°É½ºÓÉçğ¢Í¼¡±µÄ×÷ÓÃ£¬µ«ÊÇĞèÒªÈ¥¡°ÑãÃÅ¹Ø¡±×ö½øÒ»²½µ÷²é")
						    TaskTip("BiÕt ®­îc t¸c dông cña B¶n ®å S¬n Hµ X· T¾c nh­ng cÇn ®Õn Nh¹n M«n quan ®iÒu tra thªm!")
				else
						 Talk(1,"","ChuyÓn giao vËt phÈm kh«ng thµnh c«ng")
				end
	elseif ( UWorld1401  == 20 and GetItemCount(2,1,34) < 5 ) then
				Talk(1,"","<color=red>H¹nh Hoa th«n<color> cã nhiÒu <color=red>Quan sø<color> tham lam. H·y ®o¹t <color=red>5 bé quan phôc<color> cña chóng vÒ!")
...
function  yes1401_3()
		...
		SetTask(1401,20)
		--AddNote("È¥°ï¡°²Ü´óÁ¦¡±ÊÕ¼¯5Ì×¹Ù·ş£¬²ÅÄÜ½øÒ»²½´òÌıµ½ÏûÏ¢¡£")
		TaskTip("Gióp Tµo §¹i Lùc thu thËp 5 bé quan phôc, cã thÓ dä th¸m thªm chót tin tøc!")
end;
