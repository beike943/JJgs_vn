...
-- ½£ÏÀÇéÔµonlineII ´óÀíÈÎÎñNPC½ôÄÇÂÞScript
-- By StarryNight
-- 2006/01/13 PM 20:37
...
function OnDeath()
    ...
    if nMemCount == 0 then -- Íæ¼ÒÎ´×é¶Ó
        if GetTask(TASK_DL_LV80_ID) == 6 then
        	...
        	AddItem(2,0,383,1,1);--µÃµ½ÈÎÎñÎïÆ·ÒýÏß
        	Msg2Player("§· ®¸nh b¹i KhÈn Na La, h·y mau vÒ §¹i Lý giao kim kh©u cho quèc s­!");
        	TaskTip("§· ®¸nh b¹i KhÈn Na La, h·y mau vÒ §¹i Lý giao kim kh©u cho quèc s­!");
        end;
    else
