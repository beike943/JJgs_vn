...
function jieshao()
	Say("Lam Nh¹c th«n lµ khu vùc canh t¸c cao cÊp. Tr¸i ph¶i phİa trªn cã nhiÒu <color=yellow>H¹t kª Du Long cÊp 8<color>. Bªn tr¸i phİa d­íi mäc ®Çy <color=yellow>Phông Qu¸n Tóc cÊp 9<color>, bªn ph¶i lµ <color=yellow>Dao Chi Tóc cÊp 10<color>.",0)
end;
