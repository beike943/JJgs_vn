...
function main()
	local selTab = {
				...
				"§Õn Doanh D©n Th«n (trung cÊp)/#NewWorld(718,1708,3405)",
...
function jieshao()
	Say("Thanh Thñy th«n lµ khu vùc canh t¸c s¬ cÊp. Bªn tr¸i phİa trªn cã mäc nhiÒu <color=yellow>Quang Th«ng Ma vµ Méc nhÜ cÊp 1<color>, bªn ph¶i lµ <color=yellow>Khuynh ly ®Ëu vµ Th¹ch khuÈn cÊp 2<color>. Bªn tr¸i phİa d­íi mäc ®Çy <color=yellow>NhiÔu minh ®Ëu cÊp 3, M¨ng tróc<color>, bªn ph¶i lµ <color=yellow>Dung tr¹ch cèc, Hå Tiªu cÊp 4<color>.",0)
end;
