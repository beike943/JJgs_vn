	...
	[1] =
		{
        	...
        	t_other_group = --×°±¸×é
        	{
                ...
                { {"¸o Choµng T¹o Bè", {0,152,1,1}, nil,nil, {1, 100}}, 600},
                { {"¸o Choµng CÈm §o¹n", {0,152,2,1}, nil,nil, {1, 100}}, 600},
                { {"¸o Choµng Háa V©n", {0,152,3,1}, nil,nil, {1, 100}}, 600},
                { {"¸o Choµng Ngò Hµnh Kim ChÕ", {0,152,4,1}, nil,nil, {1, 100}}, 50},
                { {"¸o Choµng Ngò Hµnh Méc ChÕ", {0,152,5,1}, nil,nil, {1, 100}}, 50},
                { {"¸o Choµng Ngò Hµnh Thñy ChÕ", {0,152,6,1}, nil,nil, {1, 100}}, 50},
                { {"¸o Choµng Ngò Hµnh Háa ChÕ", {0,152,7,1}, nil,nil, {1, 100}}, 50},
                { {"¸o Choµng Ngò Hµnh Thæ ChÕ", {0,152,8,1}, nil,nil, {1, 100}}, 50},
                { {"¸o Choµng Ngò Hµnh ¢m ChÕ", {0,152,9,1}, nil,nil, {1, 100}}, 50},
                { {"¸o Choµng Du HiÖp", {0,152,26,1}, nil,1, {1, 100}}, 1},
                { {"¸o Choµng ThiÕt HuyÕt", {0,152,27,1}, nil,1, {1, 100}}, 1},
                { {"¸o Choµng V©n Du", {0,152,28,1}, nil,1, {1, 100}}, 1},
        	},
		},
	[2] =
		{
...
_t_ib_award_no_stage1 =
{
	...
	t_ib_award =--ib½±Àø
	{
        ...
        { {"¸o Choµng T¹o Bè", {0,152,1,1}, nil,nil, {1, 100}}, 400},
        { {"¸o Choµng CÈm §o¹n", {0,152,2,1}, nil,nil, {1, 100}}, 400},
        { {"¸o Choµng Háa V©n", {0,152,3,1}, nil,nil, {1, 100}}, 306},
        { {"¸o Choµng Ngò Hµnh Kim ChÕ", {0,152,4,1}, nil,nil, {1, 100}}, 100},
        { {"¸o Choµng Ngò Hµnh Méc ChÕ", {0,152,5,1}, nil,nil, {1, 100}}, 100},
        { {"¸o Choµng Ngò Hµnh Thñy ChÕ", {0,152,6,1}, nil,nil, {1, 100}}, 100},
        { {"¸o Choµng Ngò Hµnh Háa ChÕ", {0,152,7,1}, nil,nil, {1, 100}}, 100},
        { {"¸o Choµng Ngò Hµnh Thæ ChÕ", {0,152,8,1}, nil,nil, {1, 100}}, 100},
        { {"¸o Choµng Ngò Hµnh ¢m ChÕ", {0,152,9,1}, nil,nil, {1, 100}}, 100},
        { {"¸o Choµng Du HiÖp", {0,152,26,1}, nil,1, {1, 100}}, 1},
        { {"¸o Choµng ThiÕt HuyÕt", {0,152,27,1}, nil,1, {1, 100}}, 1},
        { {"¸o Choµng V©n Du", {0,152,28,1}, nil,1, {1, 100}}, 1},
	},
