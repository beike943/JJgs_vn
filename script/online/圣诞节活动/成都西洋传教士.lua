...
--	if nTemp == 1 then
--		Say("<color=green>Íş¶ûÑ·½ÌÖ÷<color>£ºÉñµÄ½Ì»¯ÈÃÎÒÀ´µ½ÄãÕâÀï£¬ÉñµÄÖ¸ÒıÈÃÄãÀ´µ½ÎÒÕâÀï¡£",0)
--	else
--		Say("<color=green>Íş¶ûÑ·½ÌÖ÷<color>£ºÆäÊµÎÒµÄÓ¢ÎÄÃû×Ö½Ğ×ö¡°wilson¡±¡£",0)
--	end
end
