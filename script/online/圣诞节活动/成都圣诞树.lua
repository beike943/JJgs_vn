...
function give_present()
	...
	if nEmpty == 1 then
		AddGlobalNews("Quµ c©y th«ng Gi¸ng Sinh ë Nam Thµnh §« ®· bŞ lÊy hÕt, ng­êi ch¬i nµo ch­a lÊy ®­îc h·y ®Õn lÇn sau.")
		Msg2SubWorld("Quµ c©y th«ng Gi¸ng Sinh ë Nam Thµnh §« ®· bŞ lÊy hÕt, ng­êi ch¬i nµo ch­a lÊy ®­îc h·y ®Õn lÇn sau.")
	end
end
