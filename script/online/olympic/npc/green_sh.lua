...
function main()
	...
	local sTitle = "Lôc S¾c Th¸nh Háa : C¸c h¹ ®· th¾p s¸ng céng dån %d lÇn , th¾p s¸ng thªm  %d lÇn n÷a sÏ nhËn ®­îc %s gi¶i th­ëng";
...
function free_fire()
	if gf_GetTaskBit(VET_OLY_TASK3,3) ~= 0 then
	...
	--±ê¼ÇÖÃ1
	gf_SetTaskBit(VET_OLY_TASK3,3,1,TASK_ACCESS_CODE_OLYMPIC);
	SetCurrentNpcSFX(GetTargetNpc(),974,2,0,3);
	--µ±ÈÕµã»ð´ÎÊý
