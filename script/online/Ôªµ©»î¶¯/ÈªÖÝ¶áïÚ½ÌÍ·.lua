...
function hand_up()
	...
	if GetTaskTemp(TASK_FLAG_FOLLOW) == 1 then
		...
		if GetGlbValue(ID_FLAG_NUMBER_QZ) == 0 then
			AddGlobalNews("5 tiªu kú ë B¾c TuyÒn Ch©u ®· bŞ lÊy hÕt, ho¹t ®éng ë khu vùc nµy ®· kÕt thóc.")
			Msg2SubWorld("5 tiªu kú ë B¾c TuyÒn Ch©u ®· bŞ lÊy hÕt, ho¹t ®éng ë khu vùc nµy ®· kÕt thóc.")
			return 0
		end
		Msg2SubWorld("B¾c TuyÒn Ch©u cßn"..flag_left.."tiªu kú.")
	end
end
