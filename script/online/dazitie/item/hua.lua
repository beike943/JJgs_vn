function OnUse(nItem)
	Say("[Hoa]:".."C¸c h¹ chän h×nh thøc nµo ®Ó viÕt l¹i?",3,"ViÕt l¹i tèn 40 vµng/cost_coin","Dïng bót l«ng viÕt l¹i/cost_item","Tho¸t/do_nothing");
end
...
function cost_coin()
	...
	local nNum = GetItemCount(2, 1, 30447);
...
function cost_coin_deal(nNum)
	if DelItem(2, 1, 30447, nNum) ~= 1 then
		return 0;
	end
