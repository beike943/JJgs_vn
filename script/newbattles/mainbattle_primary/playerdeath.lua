...
function OnDeath(Launcher)
	...
	if random(1,100) <= nTransmitProbability then	--·ûºÏ´«ËÍ¸ÅÂÊ
		...
		WantTo1v1(nKillerIndex, "B¹n bŞ "..sKillerName.." giÕt chÕt, muèn tr¶ thï kh«ng? §Õm ng­îc %d gi©y", OPERATE_TIME, "\\script\\newbattles\\mainbattle_primary\\playerdeath.lua")
		PlayerIndex = nKillerIndex;
...
function OnWant(nKillerIndex, nType)
	...
	Accept1v1(nDeathIndex, sDeathName.."khiªu chiÕn víi b¹n, ®ång ı kh«ng? NÕu tõ chèi sÏ bŞ trõ 1 İt ®iÓm tİch lòy. §Õm ng­îc %d gi©y", 10, "\\script\\newbattles\\mainbattle_primary\\playerdeath.lua")
	PlayerIndex = nOldPlayerIndex;
end;
--½ÓÊÜµ¥Ìô
