...
function Process_Fight_Timer()
	...
	if nLoop == 0 then	
		...
		if nResSong > nResLiao then
			sResult = "Phe Tèng giµnh th¾ng lîi chung cuéc t¹i chiÕn dÞch Thu ThËp L­¬ng Th¶o"
		elseif nResLiao > nResSong then
			sResult = "Phe Liªu giµnh th¾ng lîi chung cuéc t¹i chiÕn dÞch Thu ThËp L­¬ng Th¶o"
		else
			sResult = "Tèng-Liªu ®«i bªn bÊt ph©n th¾ng b¹i t¹i chiÕn dÞch Thu ThËp L­¬ng Th¶o"
		end;
		BT_ClearRelayData();
