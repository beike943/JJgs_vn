...
function main()
	...
	local selTab = {
			...
			"Bæn So¸i muèn triÖu tËp chiÕn thÇn ph¸ vßng v©y qu©n ®Şch/summon_god_of_war",
...
function knowbackground()
	...
	Talk(1,"main","<color=green>"..sNpcName.."<color>: Nh¹n M«n Quan ®Şa thÓ hiÓm trë víi nhiÒu ®­êng nhá th«ng suèt. Ba háa ph¸o trªn ®Ønh cã thÓ khèng chÕ toµn côc diÖn. Chİnh gi÷a chiÕn tr­êng lµ n¬i d©n lµng tu tËp, cã rÊt nhiÒu ®iÓm tµi nguyªn vµ n¹n d©n, nÕu kh«ng chÕ ®­îc hä ta tin n¾m ch¾c phÇn th¾ng. C¸c vŞ cè g¾ng lªn!");
end;
