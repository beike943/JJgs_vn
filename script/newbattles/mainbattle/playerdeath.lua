...
--			ClearColdDown();	--«Â≥˝À˘”–“©CD
	...
	if random(1,100) <= nTransmitProbability then	--∑˚∫œ¥´ÀÕ∏≈¬ 
		...
		WantTo1v1(nKillerIndex, "Bπn bﬁ "..sKillerName.." gi’t ch’t, muËn tr∂ thÔ kh´ng? ß’m ng≠Óc %d gi©y", OPERATE_TIME, "\\script\\newbattles\\mainbattle\\playerdeath.lua")
		PlayerIndex = nKillerIndex;
...
function OnWant(nKillerIndex, nType)
	...
	Accept1v1(nDeathIndex, sDeathName.."khi™u chi’n vÌi bπn, ÆÂng ˝ kh´ng? N’u tı chËi sœ bﬁ trı 1 ›t Æi”m t›ch lÚy. ß’m ng≠Óc %d gi©y", OPERATE_TIME, "\\script\\newbattles\\mainbattle\\playerdeath.lua")
	PlayerIndex = nOldPlayerIndex;
end;
--Ω” ‹µ•ÃÙ
