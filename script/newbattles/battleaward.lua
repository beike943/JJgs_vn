...
function BTA_Main()
	...
	tinsert(selTab, 1, "Ta muèn ®æi trang bÞ Kim Xµ - Nguyªn So¸i/DoiTrangBiKimXa_NguyenSoai_Menu")
--	tinsert(selTab, 1, "Ta muèn ®æi trang bÞ Kim Xµ - T­íng Qu©n/DoiTrangBiKimXa_TuongQuan_Menu")
