...
szItemDetail = 		{9,2}			-- ²É¼¯ÎïÆ·µÄ¸±Àà
szItemParticular = 	{4,23}			-- ²É¼¯ÎïÆ·µÄÏêÏ¸Àà±ğ
szItemGailv = 		{85,100}		-- ²É¼¯ÎïÆ·µÄ¸ÅÂÊ£¨ÕâÀïÌîµÄÊ±ºò£¬ºóÃæÒ»¸öÒª¼ÓÉÏÇ°ÃæÒ»¸öµÄ¸ÅÂÊ£©
szItemLowCount =	{20,4}		-- ²É¼¯ÎïÆ·×îµÍÊıÁ¿
...
nDigToolParticular = {15, 27}		-- ²É¼¯¹¤¾ßÏêÏ¸Àà
...
function OnProgressCallback()
	...
	-- ÌáÊ¾
	if (nChoice == 1) then
		Say("T¬ nµy rÊt tèt, b¹n t×m ®­îc "..nSelCount.."sîi L·nh trïng t¬!", 0)
	elseif (nChoice == 2) then
		Say("Kh«ng ngê bªn trong cßn gãi hµng, b¹n nhËn ®­îc "..nSelCount.." Háa C¸n cÈm!", 0)
	else
