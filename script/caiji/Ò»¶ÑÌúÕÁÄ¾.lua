...
szItemParticular = 	{10,58}			-- ²É¼¯ÎïÆ·µÄÏêÏ¸Àà±ğ
...
nDigToolParticular = {14, 26}		-- ²É¼¯¹¤¾ßÏêÏ¸Àà
...
function OnProgressCallback()
	...
	-- ÌáÊ¾
	if (nChoice == 1) then
		Say("ThiÕt Ch­¬ng méc nµy rÊt tèt, b¹n t×m ®­îc "..nSelCount.."ThiÕt Ch­¬ng méc!", 0)
	elseif (nChoice == 2) then
		Say("Tuy ch­a t×m ®­îc vËt liÖu gç nh­ng ng­¬i ph¸t hiÖn ra"..nSelCount.." tÊm ThÇn Binh phæ!", 0)
	else
