...
szItemParticular = 	{3,21}			-- ²É¼¯ÎïÆ·µÄÏêÏ¸Àà±ğ
...
function OnProgressCallback()
	...
	-- ÌáÊ¾
	if (nChoice == 1) then
		Say("T¬ nµy rÊt tèt, b¹n t×m ®­îc "..nSelCount.." T¬ Ngò S¾c!", 0)
	elseif (nChoice == 2) then
		Say("Kh«ng ngê bªn trong cßn gãi hµng, b¹n nhËn ®­îc "..nSelCount.." H¾c cÈm!", 0)
	else
