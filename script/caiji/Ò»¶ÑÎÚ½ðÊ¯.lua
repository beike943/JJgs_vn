...
szItemDetail = 		{8,2}			-- ²É¼¯ÎïÆ·µÄ¸±Àà
szItemParticular = 	{5,27}			-- ²É¼¯ÎïÆ·µÄÏêÏ¸Àà±ğ
...
nDigToolParticular = {11, 23}		-- ²É¼¯¹¤¾ßÏêÏ¸Àà
...
function OnProgressCallback()
	...
	-- ÌáÊ¾
	if (nChoice == 1) then
		Say("¤ kim Th¹ch nµy rÊt tèt, b¹n t×m ®­îc "..nSelCount.."¤ kim Th¹ch!", 0)
	elseif (nChoice == 2) then
		Say("Tuy kh«ng t×m ®­îc kho¸ng th¹ch nh­ng ng­¬i ®· ph¸t hiÖn ra"..nSelCount.." Liªn Hoµnh phæ!", 0)
	else
