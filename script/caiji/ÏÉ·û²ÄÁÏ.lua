...
szItemParticular = 	{31,34,29}			-- ²É¼¯ÎïÆ·µÄÏêÏ¸Àà±ğ
...
nSkillID = 7						-- ¼¯Áé¼¼ÄÜID
nSkillLevelLow = 61					-- ĞèÒª´ïµ½µÄ²É¼¯¼¼ÄÜ×îµÍµÈ¼¶
nSkillLevelHigh = 80				-- ĞèÒª´ïµ½µÄ²É¼¯¼¼ÄÜ×î¸ßµÈ¼¶
...
function OnProgressCallback()
	...
	-- ÌáÊ¾
	if (nChoice == 1) then
		Say("VËt liÖu linh phï nµy cã thÓ dïng, ng­¬i t×m ®­îc"..nSelCount.." §an T©m sa!", 0)
	elseif (nChoice == 2) then
		Say("Kh«ng ngê bªn trong cßn mét sè ®å, b¹n nhËn ®­îc "..nSelCount.." Thanh ¤ Linh HuyÕt!", 0)
