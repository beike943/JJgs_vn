...
szItemParticular = 	{42,27}			-- ²É¼¯ÎïÆ·µÄÏêÏ¸Àà±ğ
...
function OnProgressCallback()
	...
	-- ÌáÊ¾
	if (nChoice == 1) then
		Say("D­¬ng méc nµy rÊt tèt, b¹n t×m ®­îc "..nSelCount.."D­¬ng méc!", 0)
	elseif (nChoice == 2) then
		Say("Tuy ch­a t×m ®­îc vËt liÖu gç nh­ng ng­¬i ph¸t hiÖn ra"..nSelCount.." Liªn Hoµnh phæ!", 0)
	else
