...
function OnProgressCallback()
	...
	-- ÌáÊ¾
	if (nChoice == 1) then
		Say("Tµng Hång Hoa nµy rÊt tèt, b¹n t×m ®­îc "..nSelCount.." Tµng Hång Hoa!", 0)
	elseif (nChoice == 2) then
		Say("Kh«ng ngê bªn trong cßn gãi hµng, b¹n nhËn ®­îc "..nSelCount.." Da hæ tr¾ng!", 0)
	else
