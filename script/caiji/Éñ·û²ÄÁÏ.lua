...
nTotalItemCount = 3					-- ×Ü¹²ÓĞ¶àÉÙ²É¼¯ÎïÆ·

szItemGenre = 		{2,2,2}			-- ²É¼¯ÎïÆ·µÄ´óÀà
szItemDetail = 		{2,2,2}			-- ²É¼¯ÎïÆ·µÄ¸±Àà
szItemParticular = 	{32,35,29}			-- ²É¼¯ÎïÆ·µÄÏêÏ¸Àà±ğ
szItemGailv = 		{45,90,100}		-- ²É¼¯ÎïÆ·µÄ¸ÅÂÊ£¨ÕâÀïÌîµÄÊ±ºò£¬ºóÃæÒ»¸öÒª¼ÓÉÏÇ°ÃæÒ»¸öµÄ¸ÅÂÊ£©
szItemLowCount =	{25,25,10}		-- ²É¼¯ÎïÆ·×îµÍÊıÁ¿
szItemHighCount =	{40,40,15}		-- ²É¼¯ÎïÆ·×î¸ßÊıÁ¿

nSkillType = 0						-- ²É¼¯ÀàÉú»î¼¼ÄÜ´óÀàĞÍ
nSkillID = 7						-- ¼¯Áé¼¼ÄÜID
nSkillLevelLow = 31					-- ĞèÒª´ïµ½µÄ²É¼¯¼¼ÄÜ×îµÍµÈ¼¶
nSkillLevelHigh = 60				-- ĞèÒª´ïµ½µÄ²É¼¯¼¼ÄÜ×î¸ßµÈ¼¶
...
function OnProgressCallback()
	...
	-- ÌáÊ¾
	if (nChoice == 1) then
		Say("VËt liÖu linh phï nµy cã thÓ dïng, ng­¬i t×m ®­îc"..nSelCount.." Bİch HuyÕt Sa!", 0)
	elseif (nChoice == 2) then
		Say("Kh«ng ngê bªn trong cßn mét sè ®å, b¹n nhËn ®­îc "..nSelCount.." HuyÒn H¹c Linh HuyÕt!", 0)
	elseif (nChoice == 3) then
		Say("Kh«ng ngê bªn trong cßn mét sè ®å, b¹n nhËn ®­îc "..nSelCount.." §én Gi¸p Th­!", 0)
	else
