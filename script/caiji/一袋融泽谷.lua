...
szItemGenre = 		{1,1}			-- ²É¼¯ÎïÆ·µÄ´óÀà
szItemDetail = 		{3,3}			-- ²É¼¯ÎïÆ·µÄ¸±Àà
szItemParticular = 	{12,22}			-- ²É¼¯ÎïÆ·µÄÏêÏ¸Àà±ğ
szItemGailv = 		{50,100}		-- ²É¼¯ÎïÆ·µÄ¸ÅÂÊ£¨ÕâÀïÌîµÄÊ±ºò£¬ºóÃæÒ»¸öÒª¼ÓÉÏÇ°ÃæÒ»¸öµÄ¸ÅÂÊ£©
szItemLowCount =	{20,20}		-- ²É¼¯ÎïÆ·×îµÍÊıÁ¿
szItemHighCount =	{30,30}		-- ²É¼¯ÎïÆ·×î¸ßÊıÁ¿

nSkillType = 0						-- ²É¼¯ÀàÉú»î¼¼ÄÜ´óÀàĞÍ
nSkillID = 3						-- ÊÕ¸û¼¼ÄÜID
nSkillLevelLow = 31					-- ĞèÒª´ïµ½µÄ²É¼¯¼¼ÄÜ×îµÍµÈ¼¶
nSkillLevelHigh = 40				-- ĞèÒª´ïµ½µÄ²É¼¯¼¼ÄÜ×î¸ßµÈ¼¶
...
function OnProgressCallback()
	...
	-- ÌáÊ¾
	if (nChoice == 1) then
		Say("Dung tr¹ch cèc nµy rÊt tèt, ng­êi t×m ®­îc"..nSelCount.." Dung tr¹ch cèc!", 0)
