...
-- Desc     : Îäµ±bossµôÂäµÄ°ü¹üµÄ½Å±¾£¬ÃÅÅÉbossÈÎÎñÖĞµôÂäµÄ°ü¹ü£¬µã»÷Ê¹ÓÃ¿ÉÒÔ»ñµÃºÃ¶àgood¶«Î÷µÄ¹¦ÄÜ
-- Date     : Dec 26 2006
...
function OnUse()
	...
	Say("B¹n x¸c ®Şnh më tói th­ t×nh nµy chø?",
		2,
		"§ång ı/confirm_get",
...
function confirm_get()
	...
	if (DelItem(2, 1, 958, 1) == 1) then		-- °Ñ×Ô¼ºÉ¾³ı
		...
		local nRandIdx = random(1,getn(tGaojiMiji[13]));
			...
			Msg2Player("§¹i hiÖp më Tói tïy th©n, nhËn ®­îc "..tGaojiMiji[13][nRandIdx][1]);
		else	
