-- =============================================================
-- FileName : tangmen_baoguo.lua
-- Desc     : ÌÆÃÅbossµôÂäµÄ°ü¹üµÄ½Å±¾£¬ÃÅÅÉbossÈÎÎñÖĞµôÂäµÄ°ü¹ü£¬µã»÷Ê¹ÓÃ¿ÉÒÔ»ñµÃºÃ¶àgood¶«Î÷µÄ¹¦ÄÜ
-- Date     : Dec 26 2006
...
-- ÌÆÃÅ±¦ÏäµÄ½Å±¾£¬·¢½±Í¨ÓÃ
Include("\\script\\task\\faction_boss\\boss_baoxiang_tangmen.lua");
...
function confirm_get()
	...
	if (DelItem(2, 1, 961, 1) == 1) then		-- °Ñ×Ô¼ºÉ¾³ı
		...
		local nRandIdx = random(1,getn(tGaojiMiji[5]));
			...
			Msg2Player("§¹i hiÖp më Tói tïy th©n, nhËn ®­îc "..tGaojiMiji[5][nRandIdx][1]);
		else	
