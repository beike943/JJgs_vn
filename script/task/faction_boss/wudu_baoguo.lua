-- =============================================================
-- FileName : wudu_baoguo.lua
-- Desc     : Îå¶¾bossµôÂäµÄ°ü¹üµÄ½Å±¾£¬ÃÅÅÉbossÈÎÎñÖĞµôÂäµÄ°ü¹ü£¬µã»÷Ê¹ÓÃ¿ÉÒÔ»ñµÃºÃ¶àgood¶«Î÷µÄ¹¦ÄÜ
-- Date     : Dec 26 2006
...
-- Îå¶¾±¦ÏäµÄ½Å±¾£¬·¢½±Í¨ÓÃ
Include("\\script\\task\\faction_boss\\boss_baoxiang_wudu.lua");
...
function confirm_get()
	...
	if (DelItem(2, 1, 963, 1) == 1) then		-- °Ñ×Ô¼ºÉ¾³ı
		...
		local nRandIdx = random(1,getn(tGaojiMiji[19]));
			...
			Msg2Player("§¹i hiÖp më Tói tïy th©n, nhËn ®­îc "..tGaojiMiji[19][nRandIdx][1]);
		else	
