-- =============================================================
-- FileName : shaolin_baoguo.lua
-- Desc     : ÉÙÁÖbossµôÂäµÄ°ü¹üµÄ½Å±¾£¬ÃÅÅÉbossÈÎÎñÖĞµôÂäµÄ°ü¹ü£¬µã»÷Ê¹ÓÃ¿ÉÒÔ»ñµÃºÃ¶àgood¶«Î÷µÄ¹¦ÄÜ
-- Date     : Dec 26 2006
...
-- ÉÙÁÖ±¦ÏäµÄ½Å±¾£¬·¢½±Í¨ÓÃ
Include("\\script\\task\\faction_boss\\boss_baoxiang_shaolin.lua");
...
function OnUse()
	...
	Say("B¹n x¸c ®Şnh më tói quµ nµy chø?",
		2,
		"§ång ı/confirm_get",
...
function confirm_get()
	...
	if (DelItem(2, 1, 959, 1) == 1) then		-- °Ñ×Ô¼ºÉ¾³ı
		...
		local nRandIdx = random(1,getn(tGaojiMiji[1]));
			...
			Msg2Player("§¹i hiÖp më Tói tïy th©n, nhËn ®­îc "..tGaojiMiji[1][nRandIdx][1]);
		else	
