...
function OnUse()
	local mertiral_need_dia = "Trong bøc tranh b¹n ph¸t hiÖn b¹n ph¸t hiÖn muèn ®óc <color=red>bé Viªm §Õ<color> cÇn cã c¸c nguyªn liÖu sau"
