...
g_ItemName = "Kû niÖm 20 n¨m §iÓn bao";
g_NeedRoom = 18;
g_NeedWeight = 200;
TSK_COUNTER = 580;
	...
	if gf_JudgeRoomWeight(g_NeedRoom,g_NeedWeight) == 1 then
		if DelItemByIndex(nItemIdx,1) == 1 then
			...
			if GetTask(581) == 0 and nCurCount >= 8 then
				SetTask(581,1);
				AddItem(2,0,1087,2);
				Msg2Player("B¹n nhËn ®­îc 2 ch×a khãa b¹c kû niÖm 20 n¨m");			
			end			
			...
			give_item(2,1,3388,1,"1 LÖnh th¸o gì miÔn phİ",5,30,1);	--1¸öÃâ·Ñ²ğ½âÁî,5%ÇÒÃ¿¿ª30¸ö°ü±Ø¸ø1¸ö¡£
			add_lingshi(6,1,5,12,0);	--Ëæ»ú6¼¶ÁéÊ¯1¿Å,5%ÇÒÃ¿¿ª12¸ö°ü±Ø¸ø1¸ö	
			--ÒÔÏÂĞèÒª·¢È«·ş¹«¸æ
			add_lingshi(7,1,0.5,40,1);	--Ëæ»ú7¼¶ÁéÊ¯1¿Å,0.5%ÇÒÃ¿¿ª40¸ö°ü±Ø¸ø1¸ö
			give_item(2,1,3205,1,"1 c¸i ThÊt HuyÒn L­u V¨n",0.5,50,1);	--1¸öÆßìÅ¬–ÎÆ,0.5%ÇÒÃ¿¿ª50¸ö°ü±Ø¸ø1¸ö
			...
			give_item(2,0,1088,1,"1 ch×a khãa vµng kû niÖm 20 n¨m",0.1,180,2);	--1°Ñ¶şÊ®ÖÜÄêÇì½ğÔ¿³×,0.1%ÇÒÃ¿¿ª180¸ö°ü±Ø¸ø1¸ö
