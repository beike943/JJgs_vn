...
-- ½£ÏÀÇéÔµonlineII É³Ä®ÃÔ¹¬NPCÎåÐÐÊ¹Ä¾Script
-- By StarryNight
-- 2007/08/07 PM 04:48
...
local strTalk = {
	...
	if nMemCount == 0 then -- Íæ¼ÒÎ´×é¶Ó
		if GetTask(TASK_XB_ID_01) == 58 then
			if GetBit(GetTask(WUXINGSHI_STATE),2) == 0 then --ÉÐÎ´É±ËÀÎåÐÐÊ¹Ä¾
				SetTask(WUXINGSHI_STATE,SetBit(GetTask(WUXINGSHI_STATE),2,1));
				 --5¸öÎåÐÐÊ¹¾ù´òµ¹
