...
-- ½£ÏÀÇéÔµonlineII É³Ä®ÃÔ¹¬NPCÎåÐÐÊ¹ÍÁScript
-- By StarryNight
-- 2007/08/07 PM 04:48
...
local strTalk = {
	...
	if nMemCount == 0 then -- Íæ¼ÒÎ´×é¶Ó
		if GetTask(TASK_XB_ID_01) == 58 then
			if GetBit(GetTask(WUXINGSHI_STATE),5) == 0 then --ÉÐÎ´É±ËÀÎåÐÐÊ¹ÍÁ
				SetTask(WUXINGSHI_STATE,SetBit(GetTask(WUXINGSHI_STATE),5,1));
				 --5¸öÎåÐÐÊ¹¾ù´òµ¹
