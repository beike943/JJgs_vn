...
function main()
	...
	if GetLevel() < 15 then
			Say("Ta cã thÓ nhanh chãng ®­a ng­¬i ®Õn thµnh thÞ kh¸c, miÔn phÝ cho t©n thñ tõ <color=yellow>cÊp 15<color> trë xuèng.Ng­êi ch¬i tõ cÊp 15 trë lªn, mçi lÇn thu phÝ <color=yellow>3 l­îng<color> mçi ng­êi. Xin hái kh¸ch quan muèn ®i ®©u?",
			6,
			"Thµnh §«/chengdu",
			"TuyÒn Ch©u/quanzhou",
			"BiÖn Kinh/bianjing",
...
function task_yes_002()
	...
	CTask:StartTask("T×m Th¸i thó TÝn sø _T­¬ng D­¬ng");
	return
end;
