...
function main()
	do
		Talk(1,"","L«i ®µi hiÖn t¹i ch­a më!");
		return
	end
    --ÉèÖÃ·µ»Øµã
...
local strSelect = {
	"L«i ®µi liªn ®Êu s­ m«n (c¸ nh©n)/#SearchValidRoom(1)",
	"Liªn quan L«i ®µi thİ luyÖn s­ m«n/AboutShiMenGame",
	"Rêi khái/OnCancel_Talk"
	};
	
	Say("L«i ®µi lµ n¬i anh hïng h¶o h¸n tû thİ vâ c«ng. Nay ®­îc sù tİn nhiÖm cña c¸c m«n ph¸i dùng lªn <color=yellow>l«i ®µi s­ m«n<color>. Xin chän h×nh thøc tû vâ:",
		getn(strSelect),
		strSelect
		);
...
local nMapId = GetWorldPos();
    ...
    if room_num > 0 and room_num <= MAX_ROOM_COUNT then
        szSay = "Say("..format("%q","§©y lµ l«i ®µi ®¬n ®Êu c¸ nh©n, hiÖn t¹i cã tæng céng "..room_num.." trËn ®Şa. C¸c h¹ h·y chän trËn ®Şa muèn vµo!<color=yellow>");
   			...
   			if SubWorld ~= -1 then
   				...
   				elseif nMapState == 1 then	
   					...
   					if GetMSPlayerCount(SINGLE_TEAM_MISSION_ID,1) > 0 and GetMSPlayerCount(SINGLE_TEAM_MISSION_ID,2) > 0 then
   						...
   						szSay = szSay..","..format("%q", SingleTeamMapTab[i][3].."(Tr¹ng th¸i: §îi khai chiÕn, hai phe ®èi chiÕn lµ ®éi "..nCaptainName_1.." vµ ®éi "..nCaptainName_2.." )/#OpenSingleTeamRoom("..i..")");
   					...
   					elseif GetMSPlayerCount(SINGLE_TEAM_MISSION_ID,1) > 0 or GetMSPlayerCount(SINGLE_TEAM_MISSION_ID,2) > 0 then
   						...
   						PlayerIndex = OldPlayer;
   						szSay = szSay..","..format("%q", SingleTeamMapTab[i][3].."(Tr¹ng th¸i: §îi thi ®Êu, tin tøc ®éi ngò:"..nCaptainName_1..", cã "..nTeamSize_1.." ng­êi.)/#OpenSingleTeamRoom("..i..")");
   					end
   				--±ÈÈüÒÑ¾­¿ªÊ¼
   				elseif nMapState == 2 then
   					...
   					PlayerIndex = OldPlayer;
   					szSay = szSay..","..format("%q", SingleTeamMapTab[i][3].."(Tr¹ng th¸i: §ang thi ®Êu, hai phe ®èi chiÕn lµ ®éi "..nCaptainName_1.." vµ ®éi "..nCaptainName_2.." )/#OpenSingleTeamRoom("..i..")");
   				elseif nMapState == 3 then
   					szSay = szSay..","..format("%q", SingleTeamMapTab[i][3].."(Tr¹ng th¸i: Thi ®Êu kÕt thóc)/#GameOverTalk");
   				end
   			end   			
   			SubWorld = OldWorld;	   					
   		end 			
    ...
    szSay = "Say("..format("%q","GÇn ®©y ®­îc «ng chñ §¹i TuyÒn Ch©u t­¬ng trî më l«i ®µi thİ luyÖn ®¬n nh©n hçn chiÕn. Ngoµi ra, mçi ngµy «ng chñ §¹i bá tiÒn tµi trî më <color=yellow>QuÇn hïng chiÕn<color> ë <color=yellow>Thµnh §«<color> vµo <color=yellow>11:00<color>, <color=yellow>11:30<color>, <color=yellow>17:00<color>, <color=yellow>17:30<color>, <color=yellow>21:00<color> vµ <color=yellow>21:30<color>. C¸c anh hïng tham gia thi ®Êu trËn thø 1 ®Òu nhËn ®­îc phÇn th­êng nhÊt ®Şnh (mçi ngµy chØ nhËn 1 lÇn); Phİ vµo trËn ë trËn thø 2 lµ 2 l­îng, ng­êi chiÕn th¾ng sÏ nhËn ®­îc phÇn th­ëng tiÒn phong phó!");
	...
	if nType == 4 then
		local nTeamNum = 0;		
		local szSay = "Say("..format("%q","GÇn ®©y ®­îc «ng chñ §¹i TuyÒn Ch©u t­¬ng trî më l«i ®µi thİ luyÖn ®¬n nh©n hçn chiÕn. Ngoµi ra, mçi ngµy «ng chñ §¹i bá tiÒn tµi trî më <color=yellow>§éi chiÕn<color> ë <color=yellow>Thµnh §«<color> vµo <color=yellow>12:00<color>, <color=yellow>12:30<color>, <color=yellow>18:00<color>, <color=yellow>18:30<color>, <color=yellow>23:00<color> vµ <color=yellow>23:30<color>. C¸c anh hïng tham gia thi ®Êu trËn thø 1 ®Òu nhËn ®­îc phÇn th­êng nhÊt ®Şnh (mçi ngµy chØ nhËn 1 lÇn); Phİ vµo trËn ë trËn thø 2 lµ 10 l­îng, ng­êi chiÕn th¾ng sÏ nhËn ®­îc phÇn th­ëng tiÒn phong phó!"); 
			szSay = szSay..","..2;--ÎªÁË×îºó¼ÓÉÏµÄÍË³öÑ¡Ïî  
...
local strTalk = {}; 
	...
	elseif nType == 4 then
		strTalk = {
			...
			"Ngoµi ra, ®éi tr­ëng bŞ rít m¹ng hoÆc vÒ thµnh khi ®ang trong giai ®o¹n thi ®Êu, ®éi m×nh sÏ bŞ xö thua!",
			"Ngoµi trËn ®Şa QuÇn hïng chiÕn, trong thêi gian nhÊt ®Şnh, t¹i Thµnh §« cßn tæ chøc §éi chiÕn. Thêi gian chia thµnh 12:00, 12:30, 18:00, 18:30 vµ 23:00, 23:30.",
			}
	end
...
local strTalk = {
	...
	"Ngoµi thi ®Êu Hçn chiÕn ®¬n ®Êu L«i ®µi, trong thêi gian nhÊt ®Şnh, t¹i Thµnh §« cßn tæ chøc QuÇn hïng chiÕn. Thêi gian chia thµnh 11:00, 11:30, 17:00, 17:30 vµ 21:00, 21:30.",
	"Yªu cÇu hiÖp kh¸ch giang hå ®¹t cÊp 60 trë lªn ®· gia nhËp m«n ph¸i tham gia. Mçi tuyÓn thñ tham gia trËn thi ®Êu thø 1 tïy ı trong 3 thêi ®iÓm ®Òu cã thÓ nhËn ®­îc phÇn th­ëng nhÊt ®Şnh (mçi ngµy chØ cã thÓ nhËn ®­îc 1 lÇn); §Õn trËn thi ®Êu thø 2, yªu cÇu nép 2 l­îng phİ vµo trËn. §­¬ng nhiªn, ng­êi chiÕn th¾ng sÏ nhËn ®­îc phÇn th­ëng vµ tiÒn phong phó.",
	"Hy väng lÇn nµy ®­îc chøng kiÕn b¶n lÜnh cña ®¹i hiÖp!",
	}
