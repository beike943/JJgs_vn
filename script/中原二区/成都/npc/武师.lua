...
function main()
	...
	elseif (nState>9) then
		...
		if GetSkillLevel(20) ==0 then
			...
			Say("Ta chİnh lµ Tæng gi¸o ®Çu cña 80 v¹n cÊm qu©n, chØ cÇn ng­¬i ®­a <color=yellow>5 l­îng b¹c<color> cã thÓ theo ta häc khinh c«ng, kh«ng biÕt ng­¬i ®©y cã høng thó?",
				2,
...
function yes_skill()
	...
	if GetCash()<500 then 
		...
		LearnSkill(20);
		Msg2Player("B¹n häc ®­îc kü n¨ng Khinh c«ng!");
