...
--describe:越南版2010年7月活动1 虎神蛋脚本文件
--=============================================

Include("\\script\\online_activites\\2010_07\\activites_01\\head.lua");--活动头文件

g_szItemSayHead = gf_FixColor(VET_201007_01_TB_ITEM_LIST[11][1], 2, 1);
...
function OnUse(nItemIdx)
    ...
    Say(format(VET_201007_01_TB_STRING_LIST[14],VET_201007_01_TB_ITEM_LIST[11][1]) ,getn(tbSay),tbSay);
end
...
function VET_201007_01_create_pet(sName)
    ...
    SummonNpc(VET_201007_01_NPC_NAMES[2],sName)
