...
function OnPutinComplete(param)
	...
	-------------------- Check material ----------------------------
	local tbMaterial = {
		[1] = {item={{gdp={2,1,1009,19}}, {gdp={2,1,30499,19}}, {gdp={2,1,1005,6}}}},
		[2] = {item={{gdp={2,1,1009,44}}, {gdp={2,1,30499,44}}, {gdp={2,1,1005,11}}}},
	}
	local nNguyenlieu = 1
...
--	local nIndex = tbThuongUngTuongQuan[nG][nD][nP][1]
	...
	LIB_Award.szLogTitle = "NANG CAP DIEU DUONG  - CHIEN CUONG CONG THUC 3"
