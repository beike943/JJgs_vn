...
SKILL = {
	...
	{"skill_burst_time",{{1,19},{5,19},{6,28},{7,28}}},
	{"skill_burst_speed_percent",{{1,100},{5,100},{6,67},{7,67}}},
	},

	SKILL_LEVEL_COST_ATTRIB	  =	--技能等级相关消耗属性
	{
	{"cost_mana_point",{{1,8},{5,24},{6,35},{7,45}}}
	},

	SKILL_LEVEL_MISSLE_ATTRIB =	--技能等级相关子弹属性
	{
	{"skill_missle_num",{{1,1},{5,1},{6,2},{7,2}}},
	...
	{
	{magic="damage_life",
	damage_factor_x={{1,70},{5,170},{6,120},{7,160}},
	damage_factor_z={{1,90},{5,170},{6,130},{7,170}},
