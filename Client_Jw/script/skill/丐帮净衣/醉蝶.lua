...
SKILL = {
	...
	{"skill_effect_persist_time",{{1,120},{8,120}}},
	{"skill_display_persist_time",{{1,120},{8,120}}},
	},

	SKILL_LEVEL_COST_ATTRIB	  =	--技能等级相关消耗属性
	{
	{"cost_mana_point",{{1,10},{7,12},{8,12}}}
	},
	...
	{
	{magic="state_attack_add_at_life_lost",
	damage_factor_z={{1,1},{4,4},{5,4},{6,5},{7,5},{8,6}},
	},
	{magic="state_attack_rate_point_add",
	damage_factor_z={{1,60},{8,200}},
	},
	{magic="state_no_affect_per_att_speed",
	damage_factor_z={{1,0},{4,0},{5,10},{6,10},{7,20},{8,20}},
	},
	},
