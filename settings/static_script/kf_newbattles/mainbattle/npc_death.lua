...
function process_npc_kill_npc(npcIndex)	
	...
	process_camp_fight_camp(nNpcCamp,sNpcName,nNpcIndex)
end;
--´¦ÀíÍæ¼ÒÉ±ËÀNPCÊÂ¼þ
...
function get_npc_camp(szNpcName)
	local nNpcCamp = 0;
	if szNpcName == "Tèng qu©n tinh binh" or szNpcName == "Tèng qu©n c­êng nâ binh" or szNpcName == "Tèng hiÖu óy" 
		or szNpcName == "Tèng §« thèng" or szNpcName == "Tèng tiªn phong" or szNpcName == "T­íng qu©n (Tèng)" 
		or szNpcName == "Tèng nguyªn so¸i" then
		nNpcCamp = SONG_ID;
	elseif szNpcName == "Liªu qu©n dòng sÜ" or szNpcName == "Liªu qu©n ng¹nh tiÔn binh" or szNpcName == "Liªu hiÖu óy" 
		or szNpcName == "Liªu §« thèng" or szNpcName == "Liªu tiªn phong" or szNpcName == "T­íng qu©n (Liªu) " 
		or szNpcName == "Liªu nguyªn so¸i" then
		nNpcCamp = LIAO_ID;
	else
		nNpcCamp = ALL_ID;
	end;
