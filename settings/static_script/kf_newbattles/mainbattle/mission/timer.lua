...
function Process_Ready_Timer()
	...
	if nLoop == 0 then
		...
		if mod(nGlobalState,10) == 3 then
			...
			AddGlobalNews("Nh¹n M«n Quan-chiÕn dÞch chÝnh s¾p khai chiÕn, nh÷ng ai ®· b¸o danh nhanh chãng vµo trong chuÈn bÞ.");
			Msg2Global("Nh¹n M«n Quan-chiÕn dÞch chÝnh s¾p khai chiÕn, nh÷ng ai ®· b¸o danh nhanh chãng vµo trong chuÈn bÞ.");
		end;
	else
		if mod(nLoop,10) == 0 then
			AddGlobalNews("Giê khai chiÕn Nh¹n M«n Quan-chiÕn dÞch chÝnh chØ cßn "..(floor(nLoop/10)*5).." phót, mêi c¸c vÞ anh hïng nhanh chãng b¸o danh tham gia!");
			Msg2Global("Giê khai chiÕn Nh¹n M«n Quan-chiÕn dÞch chÝnh chØ cßn "..(floor(nLoop/10)*5).." phót, mêi c¸c vÞ anh hïng nhanh chãng b¸o danh tham gia!");
		end;
