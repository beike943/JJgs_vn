...
function InitMission()
	...
	SetNpcScript(npcIndex,"\\settings\\static_script\\kf_newbattles\\mainbattle\\maingeneral_npc.lua");
	...
	SetNpcScript(npcIndex,"\\settings\\static_script\\kf_newbattles\\mainbattle\\soldier_npc.lua");
	npcIndex = CreateNpc("VÖ binh thµnh m«n","Binh sÜ",MAPID,1924,3725);
	SetNpcScript(npcIndex,"\\settings\\static_script\\kf_newbattles\\mainbattle\\soldier_npc.lua");
	--==================ÒÔÏÂÊÇ½Ý¾¶µÄTRAPµã====================================================
	for i=0,45 do	--×ó±ßµÄTRAPµã
		AddMapTrap(MAPID,1669*32,(3650+i)*32,"\\settings\\static_script\\kf_newbattles\\mainbattle\\trap_royal_road.lua");
		AddMapTrap(MAPID,1670*32,(3650+i)*32,"\\settings\\static_script\\kf_newbattles\\mainbattle\\trap_royal_road.lua");
	end;
	for i=0,40 do	--ÓÒ±ßµÄTRAPµã
		AddMapTrap(MAPID,1828*32,(3650+i)*32,"\\settings\\static_script\\kf_newbattles\\mainbattle\\trap_royal_road.lua");
		AddMapTrap(MAPID,1829*32,(3650+i)*32,"\\settings\\static_script\\kf_newbattles\\mainbattle\\trap_royal_road.lua");
	end;
	--========================================================================================
