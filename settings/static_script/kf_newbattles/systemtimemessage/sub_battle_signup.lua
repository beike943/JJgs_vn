...
function main()
	...
	if GetGlbValue(GLB_FORBIDBATTLE) == 0 then
		...
		if nGlobalState == 0 then
			AddGlobalNews("Ph¸o §µi ChiÕn Liªn Server s¾p khai chiÕn, mêi c¸c vÞ anh hïng nhanh chãng b¸o danh.");
			Msg2Global("Ph¸o §µi ChiÕn Liªn Server s¾p khai chiÕn, mêi c¸c vÞ anh hïng nhanh chãng b¸o danh.");
