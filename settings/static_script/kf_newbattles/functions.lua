...
--		sPersonalPoint = sStrResult.."<enter>±¾´ÎÕ½ÒÛÄú»ñµÃµÄ¸öÈË»ı·ÖÎª<color=yellow>"..nBattlePoint.."<color>¡£´ËÍâ£¬Äã»¹½«»ñµÃ<color=yellow>"..nPointAward.."<color>µã»ı·Ö½±Àø¡¢<color=yellow>"..nJunGongAward.."<color>µã¾ü¹¦½±Àø¡¢<color=yellow>"..nExpAward.."<color>µã¾­Ñé½±Àø¡£Çëµ½ÏàÓ¦µÄ±¨ÃûµãÈ¥ÁìÈ¡ÄúµÄÕ½³¡½±Àø¡£";
--	else
--		sPersonalPoint = sStrResult.."<enter>±¾´ÎÕ½ÒÛÄú»ñµÃµÄ¸öÈË»ı·ÖÎª<color=yellow>"..nBattlePoint.."<color>¡£´ËÍâ£¬Äã»¹½«»ñµÃ<color=yellow>"..nPointAward.."<color>µã»ı·Ö½±Àø¡¢<color=yellow>"..nJunGongAward.."<color>µã¾ü¹¦½±Àø¡¢<color=yellow>"..nExpAward.."<color>µã¾­Ñé½±ÀøºÍ<color=yellow>"..nGoldenExpAward.."<color>µãµÄ½¡¿µ¾­Ñé×ª¾­Ñé½±Àø¡£Çëµ½ÏàÓ¦µÄ±¨ÃûµãÈ¥ÁìÈ¡ÄúµÄÕ½³¡½±Àø¡£";
--	end;
	sPersonalPoint = sStrResult.."<enter>ChiÕn dŞch lÇn nµy b¹n nhËn ®­îc <color=yellow>"..nBattlePoint.."<color>, phÇn th­ëng ®iÓm tİch lòy: <color=yellow>"..nPointAward.."<color>, tæng ®iÓm tİch lòy: <color=yellow>"..(nBattlePoint+nPointAward).."<color>. Mêi c¸c b¹n ®Õn chç Ng­êi NhËn Th­ëng Liªn Server ë c¸c thµnh chİnh ®Ó nhËn phÇn th­ëng chiÕn tr­êng.";
