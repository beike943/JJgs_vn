...
function EndMission()
	...
	if nTimeSong > nTimeLiao then
		...
		Msg2SubWorld("Qua nh÷ng håi giao tranh ¸c liÖt  phe Tèng ®· giµnh th¾ng lîi chung cuéc t¹i Nh¹n M«n Quan-chiÕn dŞch ph¸o ®µi!");
	elseif nTimeSong == nTimeLiao then
		SetMissionV(MV_WINNER,ALL_ID);--´òÆ½
		Msg2SubWorld("Qua nh÷ng håi giao tranh ¸c liÖt, Tèng-Liªu hai bªn bÊt ph©n th¾ng b¹i t¹i Nh¹n M«n Quan-chiÕn dŞch ph¸o ®µi!");
	else
		SetMissionV(MV_WINNER,LIAO_ID);--ÁÉÓ®
		Msg2SubWorld("Qua nh÷ng håi giao tranh ¸c liÖt, phe Liªu ®· giµnh th¾ng lîi chung cuéc t¹i Nh¹n M«n Quan-chiÕn dŞch ph¸o ®µi!");
	end;
	--ÏÂÃæÁ½¸ö¹«¸æÊÇÅÚÌ¨Õ½ÌØÓĞµÄ£¬ÒòÎªÅÚÌ¨Õ½½áÊøµÄÊ±ºò£¬ÁíÁ½¸öÕ½³¡±Ø½áÊø£¬Òò´ËÁíÁ½¸öÕ½³¡½áÊøÊ±²»±Ø·¢Í¨¸æ
	--AddGlobalNews("ÑãÃÅ¹Ø²İ¹È³¡Õù¶áÕ½¡¢ÑãÃÅ¹ØÅÚÌ¨Õù¶áÕ½¡¢ÑãÃÅ¹Ø´åÂäÕù¶áÕ½Èı³¡Õ½ÒÛ¾ùÒÑÕ½¶·Íê±Ï£¬ÑãÃÅ¹ØÖ÷Õ½³¡½«ÔÚ15·ÖÖÓºó¿ªÊ¼£¬ÇëËÎÁÉË«·½½«Ê¿×÷ºÃ×÷Õ½×¼±¸¡£");
	--Msg2SubWorld("ÑãÃÅ¹Ø²İ¹È³¡Õù¶áÕ½¡¢ÑãÃÅ¹ØÅÚÌ¨Õù¶áÕ½¡¢ÑãÃÅ¹Ø´åÂäÕù¶áÕ½Èı³¡Õ½ÒÛ¾ùÒÑÕ½¶·Íê±Ï£¬ÑãÃÅ¹ØÖ÷Õ½³¡½«ÔÚ15·ÖÖÓºó¿ªÊ¼£¬ÇëËÎÁÉË«·½½«Ê¿×÷ºÃ×÷Õ½×¼±¸¡£");
