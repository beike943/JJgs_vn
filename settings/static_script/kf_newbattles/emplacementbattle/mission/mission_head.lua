...
MV_LENGXL_BOSS_NPXIDX = 38; --记录冷香菱的npcindex

--===========================================================================
TIMER_ID = 105;					--Timer的ID
--===========================================================================
READY_TIME = 30*FRAME_PER_SECOND;--报名准备时间计时器的报时间隔，３０秒
READY_TIMER_LOOP = (5*FRAME_PER_MIN/READY_TIME)-1;--报名准备时间计时器报时次数（5分钟）
FIGHT_TIME = 20*FRAME_PER_SECOND;			--打仗时间计时器的报时间隔
FIGHT_TIMER_LOOP = (35*FRAME_PER_MIN/FIGHT_TIME)-1;	--打仗时间计时器的报时次数（35分钟）
WAITOUT_TIME = 30*FRAME_PER_SECOND;		--等待结束时间计时器的报时间隔
WAITOUT_TIMER_LOOP = (0.5*FRAME_PER_MIN/WAITOUT_TIME)-1; --等待结束时间计时器的报时次数（半分钟）
--===========================================================================
INJURE_TIMER_ID = 108;			--处理炮台伤人的Timer ID
