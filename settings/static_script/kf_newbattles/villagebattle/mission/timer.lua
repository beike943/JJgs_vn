...
function Process_Fight_Timer()
	...
	if nLoop == 0 then
		...
		if nStepSong > nStepLiao then
			sResult = "Phe Tèng giµnh th¾ng lîi chung cuéc t¹i chiÕn dÞch Th«n trang";
		elseif nStepLiao > nStepSong then
			sResult = "Phe Liªu giµnh th¾ng lîi chung cuéc t¹i chiÕn dÞch Th«n trang";
		else
			sResult = "Tèng-Liªu hai bªn bÊt ph©n th¾ng b¹i t¹i chiÕn dÞch Th«n trang";
		end;
