...
function EndMission()
	...
	if nResSong > nResLiao then
		...
		Msg2SubWorld("Qua nh÷ng håi giao tranh ¸c liÖt, phe Tèng giµnh th¾ng lîi chung cuéc t¹i Nh¹n M«n Quan-chiÕn dŞch th¶o cèc!");
	elseif nResSong == nResLiao then
		SetMissionV(MV_WINNER,ALL_ID);--´òÆ½
		Msg2SubWorld("Qua nh÷ng håi giao tranh ¸c liÖt, Tèng-Liªu ®«i bªn bÊt ph©n th¾ng b¹i t¹i Nh¹n M«n Quan-chiÕn dŞch th¶o cèc!");
	else
		SetMissionV(MV_WINNER,LIAO_ID);--ÁÉÓ®
		Msg2SubWorld("Qua nh÷ng håi giao tranh ¸c liÖt, phe Liªu giµnh th¾ng lîi chung cuéc t¹i Nh¹n M«n Quan-chiÕn dŞch th¶o cèc!");
	end;
